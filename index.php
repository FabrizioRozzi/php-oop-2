<?php 
  ...
  $prodotto4 = new Product("elettronica", "led steamer coglione", 199.99);
...
<body>
  ...
  <h3>Hai diritto allo sconto del <?php echo (1- $user2->getDiscount())*100 ?> % essendo un vecchio di merda</h3>
